...
/**
 * 创建一个cookie，浏览器保存的Web浏览器，然后再发送回服务器。 cookie的值可以确定一个客户端,所以session是常用的会话管理。
 * 
 * 
 */
public class Cookie implements Cloneable {
	...
	/**
	 * 
	 * 测试字符串并返回true，如果字符串计数为a在Java语言中保留令牌。
	 * 
	 * @return boolean
	 * 
	 */
	private boolean isToken(String value) {
		...
		for (int i = 0; i < len; i++) {
			...
			// 详见相关ASCII表格描述
			// http://www.cnblogs.com/amosli/p/3832817.html
